...
public class ReclamationRest {
    ...
    @GetMapping("reclamations/creator/{idCreator}")
    public ResponseEntity<List<Reclamation>> getReclamationsByIdCreator(@PathVariable Long idCreator) {
        List<Reclamation> reclamations = reclamationService.getReclamationsByIdCreator(idCreator);
